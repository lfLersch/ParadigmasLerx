...
rules([[game,5],[
	[1,[_,rpg,game],0,
		[runescape,is,a,legendary,browser,game,.]],
	[2,[_,soccer,game],0,
		[you,can,play,fifa,.]],
	[3,[_,fps,game],0,
	...
	[4,[_,moba,game],0,
		[you,can,play,lol,.]],
	[5,[_],0,
		[say,a,type,of,game,then,i,can,recommend,one,to,you,.]]]]).

rules([[course,5],[
	[1,[_],0,
		[computer,science,is,not,a,good,option,.],
		[if,you,like,to,study,go,for,medicine,.],
		[exacts,sciences,is,always,good,if,you,like,math,.]]]]).

rules([[anime,5],[
	[1,[_,rpg,anime],0,
		[sword,art,online,is,hot,.]],
	[2,[_,soccer,anime],0,
		[galaxy,football,is,just,for,you,.]],
	[3,[_,ninja,anime],0,
		[you,have,to,watch,naruto,.]],
	[4,[_,special,skills,anime],0,
		[go,for,hunter,x,hunter,is,not,a,waste,of,time,.]],
	[5,[_],0,
		[choose,an,anime,kind,like,soccer,or,rpg,.]]]]).
